package truecolor.downloadutil.model;
...
public class DownloadInfo implements Serializable{
    ...
    public DownloadInfo( List<String> urlList, String fileName, int file_id, DownloadTaskListener downloadTaskListener, int downloadType){
//        this.url = url;
        this.fileName = fileName;
        this.file_id = file_id;
        this.downloadTaskListener = downloadTaskListener;
